...
<html lang="pt-br">
  <head>
    ...
    <style>
      ...
      #user {
        border: 2px solid #ffffff; /* Borda branca para destacar o avatar */
      }
      ...
      .card:hover {
        ...
        box-shadow: 0 1rem 3rem rgba(0, 0, 0, 0.175) !important; /* Aumenta a sombra */
      ...
      .footer {
        border-top: 1px solid #e9ecef; /* Linha sutil no topo do footer */
      }
    </style>
  </head>
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img
              src="https://via.placeholder.com/30/ffffff/000000?text=L"
              alt="Logo"
              id="logo"
          ...
          <div class="d-flex align-items-center text-white">
            <img
              ...
              height="40"
            />
            <span class="fw-bold">Nome do Usuário Logado</span>
          </div>
        </div>
      </nav>
    </header>
      ...
      <section id="section-funcoes">
        <div class="row g-4">
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div
              class="card h-100 text-center shadow-sm border-0"
              id="funcao_cadastro_leito"
            >
              <div
                class="card-body d-flex flex-column align-items-center justify-content-center"
              >
                <img
                  src="https://via.placeholder.com/60/0d6efd/ffffff?text=L"
                  alt="Ícone Leito"
                  class="logo_funcao mb-3"
                />
                <h5 class="card-title">Cadastro de Leito</h5>
                <a href="#" class="btn btn-primary mt-2 stretched-link"
                  >Acessar</a
                >
              </div>
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div
              class="card h-100 text-center shadow-sm border-0"
              id="funcao_cadastro_paciente"
            >
              <div
                class="card-body d-flex flex-column align-items-center justify-content-center"
              >
                <img
                  src="https://via.placeholder.com/60/dc3545/ffffff?text=P"
                  alt="Ícone Paciente"
                  class="logo_funcao mb-3"
                />
                <h5 class="card-title">Cadastro de Paciente</h5>
                <a href="#" class="btn btn-danger mt-2 stretched-link"
                  >Acessar</a
                >
              </div>
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div
              class="card h-100 text-center shadow-sm border-0"
              id="funcao_cadastro_funcionario"
            >
              <div
                class="card-body d-flex flex-column align-items-center justify-content-center"
              >
                <img
                  src="https://via.placeholder.com/60/198754/ffffff?text=F"
                  alt="Ícone Funcionário"
                  class="logo_funcao mb-3"
                />
                <h5 class="card-title">Cadastro de Funcionários</h5>
                <a href="#" class="btn btn-success mt-2 stretched-link"
                  >Acessar</a
                >
              </div>
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 text-center shadow-sm border-0">
              ...
              >
                <img
                  src="https://via.placeholder.com/60/ffc107/000000?text=R"
                  alt="Ícone Requisições"
                  class="logo_funcao mb-3"
                />
                <h5 class="card-title">Visualizar Requisições</h5>
                <a href="#" class="btn btn-warning mt-2 stretched-link"
                  >Acessar</a
                >
              </div>
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 text-center shadow-sm border-0">
              ...
              >
                <img
                  src="https://via.placeholder.com/60/0dcaf0/000000?text=ML"
                  alt="Ícone Modificar Leito"
                  class="logo_funcao mb-3"
                />
                <h5 class="card-title">Modificar Leito</h5>
                <a href="#" class="btn btn-info mt-2 stretched-link">Acessar</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 text-center shadow-sm border-0">
              ...
              >
                <img
                  src="https://via.placeholder.com/60/6f42c1/ffffff?text=MP"
                  alt="Ícone Modificar Paciente"
                  class="logo_funcao mb-3"
                />
                <h5 class="card-title">Modificar Paciente</h5>
                <a href="#" class="btn btn-secondary mt-2 stretched-link"
                  >Acessar</a
                >
              </div>
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 text-center shadow-sm border-0">
              ...
              >
                <img
                  src="https://via.placeholder.com/60/20c997/ffffff?text=ML2"
                  alt="Ícone Modificar Leito"
                  class="logo_funcao mb-3"
                />
                <h5 class="card-title">Modificar Leito</h5>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 text-center shadow-sm border-0">
              ...
              >
                <img
                  src="https://via.placeholder.com/60/fd7e14/ffffff?text=MF"
                  alt="Ícone Modificar Funcionário"
                  class="logo_funcao mb-3"
                />
